...
static void tuya_cb_handler(tuya_ble_cb_evt_param_t* event)
{
    ...
    case TUYA_BLE_CB_EVT_CONNECTE_STATUS:
        ...
        tuya_app_temp_alarm_ble_connect_status_change_handler(event->connect_status);
    ...
    case TUYA_BLE_CB_EVT_DP_WRITE:
        ...
        tuya_app_temp_alarm_dp_data_handler(dp_data_array);
...
void tuya_ble_app_init(void)
{
    ...
    tuya_app_temp_alarm_init();
}

void app_exe()
{
    tuya_app_temp_alarm_loop();
}
